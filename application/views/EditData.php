                ...
                <strong><i class="fa fa-plus"></i><h2>Form</h2></strong>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fname" value="<?= $key->fname ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Last Name :-</label>
                        <input type="text" name="lname" value="<?= $key->lname ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Email :-</label>
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.success === true) {
          ...
          window.location.href = response.redirect_url; // Redirect to the listdata page
        } else {
          alert(response.message);
        }
      },
